                ...
                <div class="card-body">
                    <form action="{{ route('notes.update', $note['id']) }}" method="post">
                        ...
                        <div class="col-18 mb-3">
                            ...
                            <div class="col-md-18">
                              <textarea type="text" class="form-control" id="content" name = "content">{{ $note['content'] }}</textarea>
                            </div>
                          </div>
                        <div class="type">
                            <label for="type" class="form-label">Type</label>
                            <input class="form-control" list="types" id="type" placeholder="Choose one type, please." name="type" value="{{ $note['type'] }}">
                            <datalist id="types">
                                <option value="urgent">
